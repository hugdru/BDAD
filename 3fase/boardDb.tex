...
\item Encontrar o nome, o email e a nacionalidade de todos os jogadores que participaram num dado torneio
\item Encontrar o nome, o email e a nacionalidade de todos os jogadores que participaram num dado torneio num dado escalão
\item Encontrar o nome, o email e a nacionalidade de todos os jogadores que jogam um tipo de jogo num dado escalão.
...
\item Encontrar o jogador com mais pontos de uma Equipa, para todos os jogos/partidas que ele efetuou
\item Encontrar a variância dos pontos dos jogadores de uma equipa
...
\item Ver a duração média dos jogos de um dado escalão para um dado tipo jogo
\end{itemize}
