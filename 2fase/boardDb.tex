...
\\\newline
\textbf{Jogador}(\underline{idJogador}, codigoPostal, dataNascimento, numeroAndar, rua, telefone, idPais->Pais, idCidade->Cidade, idExtensao->Extensao, email) \\
...
\textbf{Árbitro}(\underline{idÁrbitro}, codigoPostal, dataNascimento, numeroAndar, rua, telefone, idPais->Pais, idCidade->Cidade, idExtensao->Extensao, observacoes) \\
\textbf{LocalEncontro}(\underline{idLocalEncontro}, idCidade->Cidade, idExtensao->Extensao, codigoPostal, rua, telefone) \\
\textbf{Cidade}(\underline{idCidade}, nome, idPais->Pais) \textbf{TipoJogo}(\underline{idTipoJogo}, nome) \\
...
\textbf{Patrocinador}(\underline{idPatrocinador}, nome) \textbf{Escalao}(\underline{idEscalao}, nome) \\
